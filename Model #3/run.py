...
def parse_args():
    ...
    parser.add_argument("--num-episodes", type=int,
                        default=20000, help="number of episodes")
    ...
    parser.add_argument(
        "--agent-speeds", nargs="+", default=[0.8, 1.0, 1.2, 1.3], help="Speed of agents (first are adversaries)")
    ...
    # Checkpointing
    parser.add_argument("--exp-name", type=str, default="run_x1",
                        help="name of the experiment")
    parser.add_argument("--save-dir", type=str, default="saves",
                        help="directory in which training state and model should be saved")
    parser.add_argument("--save-rate", type=int, default=1000,
                        help="save model once every time this many episodes are completed")
    parser.add_argument("--load-dir", type=str, default="saves",
